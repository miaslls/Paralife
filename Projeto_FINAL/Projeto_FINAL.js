...
// ----- solicita a escolha da profissão do jogador e atualiza o objeto player
...
`);
  ...
  // atualiza o objeto player

  player.job.title = chosenJob.title;
...
let gameName = formatFunctions.formatToTitle("ռօʍɛ ɖօ ʝօɢօ"); // TODO: define game name
...
`);
  ...
  let activityChoice = formatFunctions.formatPromptMultipleLines(
